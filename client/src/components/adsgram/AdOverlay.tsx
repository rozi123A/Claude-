  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Ad content area — Telegram-pattern fill */}
        <div style={{
          margin: "0 14px",
          height: 200,
          borderRadius: 12,
